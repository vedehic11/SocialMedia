...
<div className="mb-3">
  ...
  <div className="mb-3">
    ...
    <textarea rows="4" type="text" ref={postBodyElement} className="form-control" id="body" placeholder="Tell everyone more about it..."/>
  </div>

  <div className="mb-3">
    <label htmlFor="reactions" className="form-label">Number of people reacted to this post??</label>
    <input type="text" ref={reactionsElement} className="form-control" id="reactions" placeholder="how many people reacted?"/>
  </div>

  <div className="mb-3">
    <label htmlFor="title" className="tags">Enter Hashtags here</label>
    <input type="text" ref={tagsElement} className="form-control" id="tags" placeholder="#...."/>
  </div>
